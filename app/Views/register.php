	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				...
				<img id="image" rel="preload" data-size="512" class="img-responsive" src="https://cdn.icon-icons.com/icons2/1286/PNG/512/4_85233.png" title="Semangka, lucu, makanan Ikon Gratis" alt="semangka, lucu, makanan Ikon" width="75px" alt="" >
					<h2 class="heading-section">Form Registrasi Aplikasi Pengaduan Masyarakat </h2>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<div class="form-group">
		      			<input name="txtTelp" type="text" class="form-control" placeholder="Telepon" required>
		      		</div>
	            <div class="form-group">
