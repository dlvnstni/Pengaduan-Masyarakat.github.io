...
class Laporan extends BaseController
{
	...
	public function pengaduanTampil(){
		...
		$htmlData .='<table class="table table-striped" id="dataTable" width="100%" cellspacing="5">';
		$htmlData .='<thead class="bg-light text-center">
						<tr>
						<th>No</th>
						<th>Nik</th>
						<th>Nama</th>
		...
		<button href"/print" onclick="window.print()" class="btn btn-outline-danger shadow float-right btn-sm mr-2"<i class="ri-printer-fill"></i>Print</button>
		</p>';			
		echo $htmlData;	
	}	
